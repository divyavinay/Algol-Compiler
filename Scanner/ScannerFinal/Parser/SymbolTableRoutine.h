...
public:
	...
	item* Find_All(string id, stack <SymbolTable*>copy_of_scope) {									//checks if string is in the scope above the current scope and returns the pointer to the object for	
		item *Ptr;
	...
	void PrintSymbolTable(stack <SymbolTable*>copy_of_scope) {									//checks if string is in the scope above the current scope and returns the pointer to the object for	
		item* Ptr;
